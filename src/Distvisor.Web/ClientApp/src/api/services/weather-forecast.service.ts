...
export class WeatherForecastService extends BaseService {
  ...
  weatherForecastGet$Plain$Response(params?: {
  ...
  }): Observable<StrictHttpResponse<null | Array<WeatherForecast>>> {
    ...
    return this.http.request(rb.build({
      ...
      map((r: HttpResponse<any>) => {
        return r as StrictHttpResponse<null | Array<WeatherForecast>>;
      })
    );
  }
  ...
  }): Observable<null | Array<WeatherForecast>> {

    return this.weatherForecastGet$Plain$Response(params).pipe(
      map((r: StrictHttpResponse<null | Array<WeatherForecast>>) => r.body as null | Array<WeatherForecast>)
    );
  }
