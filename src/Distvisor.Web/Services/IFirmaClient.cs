...
{
    public interface IIFirmaClient
    {
        string InvoicesApiKey { get; }
        string SubscriberApiKey { get; }
        string User { get; }
    ...
    public class IFirmaClient : IIFirmaClient
    {
        ...
        public IFirmaClient(HttpClient client)
        {
            _httpClient = client;
            _bottomDateLimit = new DateTime(2019, 10, 3);
        }

        public string InvoicesApiKey { get; private set; }
        public string SubscriberApiKey { get; private set; }
        public string User { get; private set; }

        public void Configure(string invoicesApiKey, string subscriberApiKey, string user)
        {
            InvoicesApiKey = invoicesApiKey;
            SubscriberApiKey = subscriberApiKey;
            User = user;
        }
        ...
        private void EnsureConfigured()
        {
            ...
            {
                throw new InvalidOperationException("IFirma client must be configured before first use");
            }
        }
        ...
        private async Task<AuthenticationHeaderValue> GenerateAuthHeaderAsync(HttpRequestMessage request, string apiKeyName, string apiKeyValue)
        {
            ...
            var fullUrl = request.RequestUri;
    ...
    public class FakeIFirmaClient : IIFirmaClient
    {
        private readonly INotificationService _notifications;

        public FakeIFirmaClient(HttpClient _, INotificationService notifications)
        {
        ...
        public Task<IEnumerable<Invoice>> GetInvoicesAsync()
        {
            var result = new Invoice[]
            {
                ...
                new Invoice
                {
                    ...
                    Amount = 2000,
                    Customer = "FakeCustomer",
                    IssueDate = new DateTime(2020, 2, 2),
                    Number = "FV Fake 02/2222",
                    WorkDays = 20
                },
            };
