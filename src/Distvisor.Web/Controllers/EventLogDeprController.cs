...
namespace Distvisor.Web.Controllers
{
    ...
    public class EventLogDeprController : ControllerBase
    {
        private readonly EventStoreContext _context;
        private readonly IEventLogToDtoMapper _mapper;

        public EventLogDeprController(EventStoreContext context, IEventLogToDtoMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
        ...
        [HttpGet]
        public async Task<IEnumerable<EventLogDto>> GetEvents()
        {
